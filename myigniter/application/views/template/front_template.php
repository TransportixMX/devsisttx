                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <?php foreach ($menu['children'] as $menu2): ?>
                                            <li><a href="<?php echo strpos($menu2['link'], 'http') !== false ? $menu2['link'] : site_url($menu2['link']) ?>"><?php echo $menu2['label'] ?></a></li>
                                        <?php endforeach ?>
                                    </ul>
                                </li>
                            <?php else: ?>
                                <li><a href="<?php echo strpos($menu['link'], 'http') !== false ? $menu['link'] : site_url($menu['link']) ?>"><?php echo $menu['label'] ?></a></li>
                            <?php endif ?>
                        <?php endforeach ?>
                      </ul>
                    </div><!-- /.navbar-collapse -->
